                ...
                <div class="lg:grid lg:grid-cols-5 lg:gap-2 my-6 lg:pt-10 ml-10 overflow-auto h-full 2xl:h-148">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img1.png" alt=""
                            class="object-cover absolute w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:static lg:w-full lg:h-full lg:mx-0 lg:my-0">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img3.png" alt=""
                            class="object-cover absolute lg:static w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:w-full lg:h-full lg:mx-0 lg:my-0">
